...
class DetectFrame():
    ...
    def adjust_marker_corners(self, corners, offset_x_cm=0, offset_y_cm=0, adjust_width_cm=0, adjust_height_cm=0, marker_physical_size_cm=15):
        """
    ...
    def detect_aruco_markers(self,frame, aruco_dict_type=cv2.aruco.DICT_6X6_250):
        ...
        if ids is not None:
            ...
            for id, corner in zip(ids, corners):
                ...
                #     processed_corners = self.adjust_marker_corners(
                #         processed_corners,
    ...
    def capture_update_frame(self):
        ...
        while True:
            ...
            self.markers = self.detect_aruco_markers(frame)
            # print(self.markers)
            # time.sleep(3)
...
#     frame = DetectFrame()
#     frame.capture_update_frame()import cv2
import numpy as np
import time
